![A picture containing drawing, sign Description automatically
generated](.//media/image1.png){width="0.8053094925634295in"
height="0.9047298775153105in"}
...
GUIDE]{.underline}](https://www.covidprotocols.org/pdf/QuickGuide_Hospitalist.pdf)

[[COVID-19 RESPIRATORY FAILURE QUICK
GUIDE]{.underline}](https://www.covidprotocols.org/pdf/QuickGuide_RespiratoryFailure.pdf)

[[COVID-19 INTENSIVIST QUICK
GUIDE]{.underline}](https://www.covidprotocols.org/pdf/QuickGuide_ICU.pdf)
...
6.  Anosmia (Anecdotal reports summarized by ENT groups in
    [[USA]{.underline}](https://www.entnet.org/content/aao-hns-anosmia-hyposmia-and-dysgeusia-symptoms-coronavirus-disease),
    [[UK]{.underline}](https://www.entuk.org/sites/default/files/files/Loss%20of%20sense%20of%20smell%20as%20marker%20of%20COVID.pdf))
...
1.  Large droplets and fomites most often, aerosols less often
    ...
    a.  Viral particles survive \< 24h on cardboard, \< 72h on plastic
        or steel

    b.  Aerosols (droplet nuclei, \< 5 µm), estimated \< 4h ([[van
        Dorelmalen et al, *New Engl J Med,*]{.underline}
...
3.  \~ 2-25% have respiratory viral co-infection (Qingdao, China: [[Xing
    et al, *medRxiv,*]{.underline} [2020
    preprint]{.underline}](https://www.medrxiv.org/content/10.1101/2020.02.29.20027698v2);
    Stanford, CA, USA: [[Shah N, *Medium*, 2020 unpublished
    data]{.underline}](https://medium.com/@nigam/higher-co-infection-rates-in-covid19-b24965088333))
...
4.  Mortality rate correlates with age and availability of medical
    resources ([[Ruan et al, *Intensive Care Med,*]{.underline}
...
[[COVID-19 INITIAL WORKUP FOR THE HOSPITALIST QUICK
GUIDE]{.underline}](https://www.dropbox.com/sh/gmr9xltxjhvn0rn/AACHrHZz_u9ASUTynFcatCaka?dl=0&preview=INITIAL+WORKUP+FOR+THE+HOSPITALIST-+covid+quick+guide.pdf)

[[Partners Pulse Clinical
Policies]{.underline}](https://pulse.partners.org/hub/departments/emergency_preparedness/coronavirus/covid19_clinical_policies)

[[Current Partners COVID-19 Testing
Criteria]{.underline}](https://pulse.partners.org/hub/departments/emergency_preparedness/coronavirus/covid19_testing_criteria)

[[Brigham Health PPE
Guidance]{.underline}](https://www.bwhpikenotes.org/Patient_Family_Care/Infection_Control/covid-19/documents/bh-ppe-recommendations.pdf)

[[BWH Infectious Diseases COVID-19
treatment]{.underline}](http://handbook.partners.org/content/pdf/BWHCovid19Treatment.pdf)
(only accessible behind Partners firewall)

[[Partners Guidance on Durable / Extended PPE
use]{.underline}](https://pulse.partners.org/hub/departments/emergency_preparedness/coronavirus/covid19_clinical_policies/extended_usereuse_of_masks_and_eye_protection)

[[Partners Infection Control
Guidance]{.underline}](https://pulse.partners.org/hub/departments/emergency_preparedness/coronavirus/covid19_clinical_policies/patients_with_suspected_viral_respiratory_illness)
...
1.  **Location-specific PPE guidance:** There are location-specific
    ...
    a.  Easy to read "grid" summarizing PPE
        [[here]{.underline}](http://www.bwhpikenotes.org/Patient_Family_Care/Infection_Control/covid-19/documents/bh-ppe-recommendations.pdf)
        (Partners login required)

    b.  [[Partners PPE
        Guidance]{.underline}](https://pulse.partners.org/hub/departments/emergency_preparedness/coronavirus/covid19_clinical_policies)
        (Partners login required)

2.  **For aerosol generating procedures:** Strict isolation (aerosol)
    PPE (*including N95 masks*) are needed during and for 45 mins. after
    [[aerosol generating
    procedures]{.underline}](https://pulse.partners.org/hub/departments/emergency_preparedness/coronavirus/covid19_clinical_policies/aerosol_generating_procedures)
...
3.  **To donate PPE:** Please use this
    [[link]{.underline}](https://www.brighamandwomens.org/deptforms/covid-19-donations)
...
1.  Step-by-step protocols for working in COVID-19 precaution patient
    ...
    linked
    [[here]{.underline}](https://www.dropbox.com/s/5wh1m5qupgawgyp/MICU%20Strict%20Isolation%20Room%20Manual%20of%20Procedures%202020.03.28.pdf?dl=0).
...
1.  This is an area that is actively changing and varies widely by
    ...
    criteria available
    here]{.underline}](https://pulse.partners.org/hub/departments/emergency_preparedness/coronavirus/covid19_testing_criteria)
    (Partners login required)

### Laboratory studies and EKGs 

+----------------------------------+----------------------------------+
| [On admission]{.underline}       | CBC with differential            |
|                                  |                                  |
...
+----------------------------------+----------------------------------+
| [Daily]{.underline}              | CBC with differential            |
|                                  |                                  |
...
+----------------------------------+----------------------------------+
| [Every other day]{.underline}    | LFTs, Troponin & CPK, NT-proBNP  |
|                                  |                                  |
|                                  | LDH, CRP, D-dimer, Ferritin      |
|                                  |                                  |
|                                  | *If on propofol:* Triglycerides  |
+----------------------------------+----------------------------------+
| [Weekly]{.underline} *- only in  | Glucan, Galactomannan            |
| heme malignancy / stem cell      |                                  |
| transplant patients*             | *+/- additional per primary      |
|                                  | oncologist*                      |
+----------------------------------+----------------------------------+
| **[If clinical                   | CBC with differential            |
| worsening]{.underline}**         |                                  |
|                                  | BMP, Magnesium, LFTs             |
|                                  |                                  |
...
1.  Avoid other studies unless really necessary due to PPE limitations
    ...
    a.  Avoid routine TTEs (for cardiac studies, see: [["Cardiac
        Complications of COVID" chapter]{.underline}](#_6zfga8b63w2s)).
...
2.  **Noninvasive ventilation, high flow nasal cannula:**
    ...
    b.  Because rates of asymptomatic carriage in the community are
        ...
        iii. Use a closed circuit: [BWH NIPPV machine with dual limb
             with a HEPA filter and]{.underline} [BWH mask without
             anti-asphyxia valve]{.underline}.
...
1.  **Nasal Cannula:**
    ...
    b.  If a patient requires \>6L, consult ICU (COVID ICU Triage,
        p39999) for consideration of ICU transfer. If on floor, consult
        anesthesia for assessment and close monitoring (COVID Anesthesia
        Team, p39265).
...
2.  **Noninvasive Ventilation and High Flow Nasal Cannula:**
    ...
    a.  NIPPV and HFNC should NOT be used in most circumstances,
        including to delay intubation

        i.  For patients already on NIPPV/HFNC, transition to Venturi
            mask or non-rebreather mask if possible, ideally 45 minutes
            prior to intubation
...
3.  **Early intubation:**
    ...
    b.  Rapid Sequence Induction (RSI) should be performed, avoiding
        ...
        ii. using a video laryngoscope ([[SCCM COVID19
            Guidelines]{.underline}](https://sccm.org/getattachment/Disaster/SSC-COVID19-Critical-Care-Guidelines.pdf?lang=en-US&_zs=WSjjd1&_zl=j1cc6))
            ([[APSF Considerations for Airway Manipulation,
            3/20/2020]{.underline}](https://www.apsf.org/news-updates/perioperative-considerations-for-the-2019-novel-coronavirus-covid-19/)).
...
1.  Management is largely supportive. Antiviral and immune-modulating
    ...
    and Clinical Trials"
    chapter]{.underline}](https://docs.google.com/document/d/1arxC_2CCuHSA5jyFDPvBlW31yArLinMvjwD3FM5PeI4/edit#heading=h.kx686gedgtzg).
...
4.  Security facilitates the shortest and fastest transfer route, walks
    6 ft away from patient and providers, not required to wear PPE
...
3.  Security facilitates the shortest and fastest transfer route, walks
    6 ft away from patient and providers, not required to wear PPE
...
4.  Patient is escorted directly into vehicle; contact care management
    if patient does not have access to a personal vehicle
...
1.  Consider discharge for patients' who meet the following clinical
    ...
    b.  Improvement in illness signs and symptoms (cough, SOB, and
        oxygen requirement)

### Discharge for patients with unstable housing or who leave Against Medical Advice (AMA)

1.  *Additional resources for patients with unstable housing and
    requests for AMA discharge are in development.*
...
-   Provide [[language-appropriate document reviewing community
    resources]{.underline}](https://docs.google.com/document/d/14JYALTcbGrwXwL2OipH0BSCYcT4TzkryMd06RSiHaRs/edit)
...
1.  Histology of COVID-19 associated lung disease shows bilateral
    diffuse alveolar damage with cellular fibromyxoid exudates,
    desquamation of pneumocytes, pulmonary edema, and hyaline membrane
    formation.
...
2.  From onset of symptoms, the median time to:
    ...
    a.  Development of ARDS: 8-12 days ([[Wang et al, *JAMA*,
        2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32031570);
        [[Zhou et al, *Lancet*,
        2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32171076);
        [[Huang et al, *Lancet*,
        2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/31986264))
...
1.  *Nasal cannula:*
    ...
    a.  Initial oxygen delivery should be humidified nasal cannula (NC)
        1 to 8 LPM for target SpO2 92-96%.

        i.  If a patient requires \>6L, anesthesia requests *early*
            consultation for assessment and preparation. (COVID
...
1.  For patients maintained on a Venturi mask;
    ...
    a.  once FiO2 = 60% and SpO2 \< 92%, call for intubation (COVID
        ...
        i.  Consider other indications for intubation (tachypnea, work
            of breathing).

2.  Avoid NIPPV or HFNC to stave off intubation (see discussion below)

    a.  For patients already on NIPPV/HFNC, transition to Venturi mask
...
3.  Rapid Sequence Induction(RSI) should be performed
    ...
    b.  using a video laryngoscope ([[SCCM COVID19
        Guidelines]{.underline}](https://sccm.org/getattachment/Disaster/SSC-COVID19-Critical-Care-Guidelines.pdf?lang=en-US&_zs=WSjjd1&_zl=j1cc6))([[APSF
...
1.  ***We recommend avoiding high-flow nasal cannula (HFNC) and
    ...
    a.  There is a paucity of data on the increased aerosol risk of
        these interventions, and their role in increasing transmission.
        ...
        i.  General consensus suggests that HFNC and NIPPV increase the
            ...
            interim guidance (published March
            13, 2020)]{.underline}](http://www.who.int/publications-detail/clinical-management-of-severe-acute-respiratory-infection-when-novel-coronavirus-(ncov)-infection-is-suspected)
        ...
        ii. A systematic review on SARS found that NIPPV was associated
            ...
            *PLoS One*,
            2012]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/22563403))

        iii. Other studies with very limited power exist, such as a
             post-hoc analysis that found no secondary infections in
             medical staff from patients with influenza H1N1 treated
             with HFNC (but n=20) ([[Rello et al, *J Crit
             Care,*]{.underline}
             [2012]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/22762937));

    b.  Given the rapid progression of disease in most patients, we do
        not anticipate many patients would avoid intubation using
        NIPPV/HFNC, but this remains unknown.
        ...
        i.  Case reports from China suggest high failure rates for
            ...
            2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32102726)),
            though there are some patients who may recover on HFNC.

        ii. Generally, NIPPV is thought to stave off intubation only in
            early ARDS and the data is inconsistent ([[Rochberg et al,
            *ERJ*,
            2016]{.underline}](http://nrs.harvard.edu/urn-3:HUL.InstRepos:34491883)).

2.  **Exceptions to this include:**

    a.  *As a short-term bridge to ventilator availability:*

        i.  If a patient would otherwise be a candidate for intubation
            but no ventilator is immediately available, NIPPV/HFNC can
            be considered as a bridge
    ...
    c.  *For Obstructive Sleep Apnea or Tracheobronchomalacia:*
        ...
        ii. Patients on home nocturnal NIPPV for severe sleep apnea may
            ...
            specifications below. [ ]{.underline} Patients may not use
            home NIPPV mask or nasal pillow or single-limb machine due
            to increased aerosol risk.
    ...
    a.  *For select DNI patients or those not eligible for intubation:*
        ...
        i.  this should be used only as a bridge to a short-term aim
            such as a family member's arrival or an intervention

3.  **If HFNC or NIPPV are used:**

    a.  For HFNC, patient wears surgical mask and limit flow rate to \<
        30 L/min

    b.  For BiPAP, use BWH NIPPV machine with dual limb with a HEPA
        filter and BWH mask without anti-asphyxia valve
    ...
    d.  Ensure masks/devices fit well and there is minimal air leak
        ...
        i.  Measured exhaled air distances are minimally increased with
            ...
            air travel ([[Hui et al, *Eur Respir J,*]{.underline}
            [2019]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/30705129))
...
2.  Obtain STAT portable CXR to confirm endotracheal tube location
    ...
    a.  Prioritize CXR and vent settings over procedures (such as
...
2.  **Set Initial tidal volume (Vt):**
    ...
    a.  Vt = 6 ml/kg (based on ideal body weight \[IBW\] from ARDSnet
...
![](.//media/image2.png){width="5.072916666666667in"
...
5.  **Initial FiO2:** 100% on intubation then *rapidly* wean to SpO2
    92-96% ([[Barrot et al, *N Engl J Med*,]{.underline} [ ]{.underline}
...
> ![](.//media/image3.png){width="5.380208880139983in"
> height="1.3499792213473316in"}

ii. BMI ≥ 35: titrate PEEP and FiO2 as per the ARDSnet HIGH PEEP table

> ![](.//media/image4.png){width="5.276042213473316in"
> height="1.3646587926509186in"}
...
1.  **If paralyzed, target sedation to RASS -2 to -3 (see table
    below):**

    a.  Maintain deep sedation immediately post-intubation while
        paralyzed (assume 60 minutes for Rocuronium, 10 minutes for
        succinylcholine)

        i.  [Preferred initial sedation regimen]{.underline}:

            1.  Fentanyl/Hydromorphone (boluses +/- infusion) +
                Propofol: target analgosedation and optimize analgesia
        ...
        ii. [Adjunct agent:]{.underline} Midazolam

        iii. [Use dexmedetomidine only when nearing
             extubation]{.underline}

2.  **In unparalyzed, target sedation to ventilator synchrony:**

    a.  Ventilator-induced lung injury (VILI) is common in patients who
        are not synchronous with the ventilator and can cause
        significant lasting damage**.** After paralytics have worn off,
        assess patient synchrony with the ventilator (*e.g.*, signs of
        breath-stacking, double triggering, other ventilator alarms).

        i.  Titrate sedatives/analgesics to ventilator synchrony
            allowing for deeper RASS.

        ii. If patient remains dyssynchronous despite deep sedation
            (RASS -5), initiate continuous paralytics (ensure BIS 40 to
            60 prior to initiating and during paralysis).

> ![](.//media/image5.png){width="3.2761701662292215in"
...
1.  Consider whether patient requires daily CXR:
    ...
    a.  CXR clearly indicated for:
        ...
        ii. Concern for displaced ET tube:
            ...
            1.  Sudden increase in peak inspiratory pressure or
                resistance

            2.  Decreased, unilateral breath sounds (usually on the
                right)
...
2.  COVID-19 ICU Bundle:
    ...
    a.  Ventilated patients should all have a daily ICU "Bundle" of best
        ...
        1]{.underline}](#addendum-covid-icu-bundle-checklist) for a
        proposed "COVID-19 ICU Bundle".

3.  Ventilator consults:

    a.  If you need additional assistance managing ventilator choices,
...
2.  **Minute ventilation (respiratory rate x tidal volume) typically
    ...
    a.  Titrate ventilatory parameters to pH, not PCO2.
        ...
        ii. Because tidal volumes are low, the respiratory rate often
...
1.  **Minimize oxygen toxicity:** PEEP and Fi02 drive oxygenation
    ...
    i.  The goal is to deliver a partial pressure of oxygen to perfuse
        tissues (PaO2 \> 75, Sp02 \>92%)[^1] while limiting lung injury
        from high distending pressures (Ppl \< 30) and hyperoxia (**FiO2
        \< 75**, SpO2 \< 96%)[^2].

        1.  Lower limit goals for PaO2 / SpO2 are widely debated;
...
3.  **Adjust Fi02:**
    ...
    ii. Goal FiO2 \< 75%; if FiO2 \> 75%; patient requires ventilator
        ...
        1.  It is reasonable to put a desaturating patient temporarily
...
4.  **Checking plateau pressure:**
    ...
    iii. If plateau pressure is \< 25 H20 and tidal volume \< 6 mL/kg,
         then increase tidal volume by 1 mL/kg until plateau pressure
         is \> 25 cm H2O or tidal volume = 6 mL/kg
...
1.  **Refractory Hypoxemia pathway:**
    ...
    a.  If patient is hypoxic (Pa02 \<55) on Vt = 6 ml/kg, ideal PEEP
        from PV tool (or PEEP determination from ARDSnet table for
        non-Hamilton G5 ventilators), and Fi02 \>75%, perform the
        ...
        v.  Initiate continuous inhaled epoprostenol (see [["COVID-19
            ...
            chapter]{.underline}](#_kx686gedgtzg)), and call the ECMO
            team
...
1.  **Prone early:**
    ...
    a.  We recommend early proning in severe ARDS without vasodilator
        ...
        COVID-19): \< 36 hours from ARDS onset, start discussion of
        prone when P:F \< 150, prone within 12 hours of FiO2 \> 75%
        ([[Guérin et al, *N Engl J Med*,
        2013]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/23688302)).
...
1.  The anti-viral and anti-inflammatory section below is meant to
    ...
    COVID-19 treatment
    guidelines]{.underline}](http://handbook.partners.org/content/pdf/BWHCovid19Treatment.pdf)
...
2.  This table is from the BWH Infectious Diseases COVID-19 treatment
    ...
    [[here]{.underline}](http://handbook.partners.org/content/pdf/BWHCovid19Treatment.pdf)
    to view the full guideline.

![](.//media/image6.jpg){width="6.5in" height="5.027777777777778in"}
...
1.  ID teams are enrolling for ongoing clinical trials of antiviral
    ...
    [["Systemic
    Corticosteroids"]{.underline}](#systemic-corticosteroids) and
    [["Anti-IL6
    agents"]{.underline}](#anti-il6-agents-tocilizumab-siltuximab-sarilumab)
...
1.  Clinical reports indicate that rates of bacterial superinfection of
    ...
    Anecdotal reports suggest less MRSA superinfection than is often
    seen with influenza. Unnecessary antibiotics carry risks of fluid
    ...
    [[Lippi and Plebani, *Clinica Chimica Acta*,]{.underline} [
    ]{.underline}
    [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32145275);
...
2.  Antibiotics should reflect IDSA guidelines, presumed source, and
    MDRO risk.

    a.  For empiric coverage for a presumed pulmonary source of
        infection:

        i.  In patients **without** risk factors for MRSA or
            *Pseudomonas* (*i.e.*, living in community, no prior MDROs),
            start with ceftriaxone + azithromycin.

        ii. In patients **with** risk factors for MRSA or *Pseudomonas*
            (*i.e.*, chronic hospitalization, prior MDR infections),
            start with vancomycin + cefepime and consider ciprofloxacin
            if high concern for *Pseudomonas.*
...
4.  See special dispensations for oncology patients in [["Considerations
    for Oncology Patients" section]{.underline}](#_aayfijcxre19) within
    [["Other Guidance"
    chapter]{.underline}](#neurologic-manifestations).
...
1.  Nebulization may aerosolize viral particles and contribute to
    disease transmission. COVID-19 clinical reports do not indicate
...
2.  If COVID-19 is confirmed or suspected:
    ...
    a.  Use MDI (inhalers), NOT nebulizers, due to the increased aerosol
        risk associated with nebulization. Because MDI supply is
        limited, only prescribe when needed.

3.  In patients WITHOUT suspicion for COVID-19 or COVID-19 negative:

    a.  Use nebulizers even if on droplet precautions (*e.g.,*
...
1.  At BWH, an in-line nebulizer container is part of a closed
    ...
    a.  Other hospitals may need to add this setup or add other options,
        such as a Heat-Moisture-Exchanger that allows MDI delivery into
        a closed circuit.
...
2.  Avoid routine use of chest PT, but can continue chest PT vests if
    patient uses at home (*e.g.,* CF patients) with appropriate
    isolation precautions. Patients with bronchiectasis may be
...
1.  There is no evidence of survival benefit of inhaled vasodilators in
    ARDS, and there are risks of viral aerosolization when connecting
    the device ([[Fuller et al, *Chest*,
    2015]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/25742022);
    [[Gebistorf et al, *Cochrane Database Syst Rev*,]{.underline} [
    ]{.underline}
    [2016]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/27347773);
    [[Afshari et al, *Cochrane Database Syst Rev*,
    2017]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/28806480)).
...
1.  If inhaled vasodilators are used, their use should be reevaluated at
    ...
    a.  First, try inhaled epoprostenol (Veletri):
        ...
        i.  Start continuous nebulization at 0.05 mcg/kg/min based on
            IBW ([[MDcalc online
            calculator]{.underline}](https://www.mdcalc.com/ideal-body-weight-adjusted-body-weight)).
    ...
    b.  If no response to epoprostenol, strongly consider use of inhaled
        ...
        i.  Limited *in vitro* data notes that iNO at high doses
            ...
            studied *in vivo* ([[Akerstrom et al, *J
            Virol*,]{.underline} [ ]{.underline}
            [2005]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/15650225);
            [[Gebistorf et al, *Cochrane Database Syst
            Rev*,]{.underline} [ ]{.underline}
            [2016]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/27347773)).

        ii. Inhaled NO may be included in future trial protocols, such
            as early initiation in milder disease (non-intubated).
...
1.  Data on corticosteroids for COVID-19 is mixed.
    ...
    a.  Most studies show negative effects of corticosteroids on similar
        ...
        survivors (*e.g.,* psychosis, diabetes, avascular necrosis)
        ([[Lee et al,]{.underline} [*J Clin Virol*,]{.underline} [
        ]{.underline}
        [2004]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/15494274);
        [[Stockman et al, *PLoS Med*,
        2006]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/16968120);
        [[Arabi et al, *Am J Respir Crit Care Med*,
        2018]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/29161116);
        [[WHO, *COVID-19 Interim guidance*, March
        2020]{.underline}](http://www.who.int/publications-detail/clinical-management-of-severe-acute-respiratory-infection-when-novel-coronavirus-(ncov)-infection-is-suspected);
        [[Wu et al, *JAMA Int Med*,]{.underline} [ ]{.underline}
        [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32167524)).
    ...
    b.  However, there is some evidence toward a potential benefit.
        ...
        COVID-19 positive ARDS, methylprednisolone decreased risk of
        death (HR, 0.38; 95% CI, 0.20-0.72) ([[Wu et al, *JAMA Int
        Med*,]{.underline} [ ]{.underline}
        [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32167524)).
        An earlier, non-blinded randomized controlled trial of patients
        with ARDS (not COVID-19) suggested a possible benefit to
        dexamethasone treatment: more ventilator-free days by day 28,
        and lower mortality at day 60 (21% vs 36%) ([[Villar et a,
        *Lancet Resp Med*,
        2020]{.underline}](https://www.ncbi.nlm.nih.gov/pubmed/32043986)).

### Recommendations

1.  **We recommend against using steroids for COVID-19 except as part of
    a clinical trial or if treating another indication.** This is in
    line with WHO guidance ([[WHO, *COVID-19 Interim guidance*, March
    2020]{.underline}](http://www.who.int/publications-detail/clinical-management-of-severe-acute-respiratory-infection-when-novel-coronavirus-(ncov)-infection-is-suspected)).

2.  If treating another indication, use corticosteroids at the lowest
    dose for the shortest duration:

    a.  **For asthma or COPD exacerbation**, treat with 40mg prednisone
        PO or 30mg methylprednisolone IV, once daily x 3-5 days.

    b.  **For shock with history of chronic steroid use in excess of
        10mg prednisone daily**, treat with 50mg hydrocortisone IV Q6H
        until improvement in shock.

    c.  **For multipressor shock without history of chronic steroid
        use**, treat with 50mg hydrocortisone IV Q6H until improvement
        in shock.
...
1.  IL-6 activates T cells and macrophages, among other cell types (see
    ...
    section]{.underline}](#cytokine-activation-syndrome) in [["Shock"
    chapter]{.underline}](#_dpe5gr1hwjp)). IL-6 inhibitors are approved
    for cytokine activation syndrome complications related to Chimeric
    Antigen Receptor T cell (CAR-T) therapy ([[Brudno and Kochenderfer,
    *Blood Rev*,]{.underline} [ ]{.underline}
    [2019]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/30528964);
    [[Rubin et al, *Brain*,]{.underline} [ ]{.underline}
    [2019]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/30891590)).

2.  IL-6 levels are reported to correlate with severe COVID-19. While
    patients have peripheral lymphopenia, BAL fluid is often
    lymphocytic, suggesting that IL-6 inhibition and prevention of T
    cell activation may be protective.
...
1.  **We do not recommend routine use of anti-IL-6 agents unless part of
    ...
    available (Anecdotal reports from Italy; [[National Health
...
2.  **For severe cases of COVID-19 with suspicion of cytokine activation
    ...
    chapter]{.underline}](#neurologic-manifestations)), consider use in
    conjunction with Infectious Diseases consultation.

    a.  Retrospective reviews in patients with rheumatological disease
        suggest a possible increase in serious bacterial infection, so
        use caution if secondary infection is clinically suspected.

        i.  Tocilizumab is routinely used at BWH (*e.g.*, CRS in
...
3.  **Sarilumab:** New intravenous formulation and dosing, available
    only as part of a [[clinical
    trial]{.underline}](http://www.news.sanofi.us/2020-03-16-Sanofi-and-Regeneron-begin-global-Kevzara-R-sarilumab-clinical-trial-program-in-patients-with-severe-COVID-19).
...
4.  **Tocilizumab and sarilumab** both have black box warnings for a
    risk of serious infections, including tuberculosis and other
    opportunistic infections. Patients treated with either agent should
    be tested for latent tuberculosis prior to discharge from the
    hospital and followed up in the TB clinic if that testing is
    positive.
...
1.  Hydroxychloroquine (HCQ) is an anti-malarial 4-aminoquinoline shown
    ...
    RNA viruses, including SARS-CoV-1 ([[Touret and de
    Lamballerie,]{.underline} [*Antivir Res*,
    2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32147496)).

2.  HCQ is thought to act through multiple mechanisms ([[Devaux et al,
    *Int J Antimicrob Agent*,
    2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32171740)):
    ...
    b.  **Inhibition of viral release into the host cell.** HCQ blocks
        ...
        al, *J Virol*]{.underline}
        [2004]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/15140961)).

    c.  **Reduction of viral infectivity.** HCQ has been shown to
        ...
        1994]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/8083990)).
    ...
    d.  **Immune modulation.** HCQ reduces toll-like receptors and
        ...
        2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32034323)).
...
1.  An expert consensus group out of China suggests that chloroquine
    ...
    al, *CMAPH*,
    2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32075365)).
    ...
    2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32074550)).
...
2.  Hydroxychloroquine was found to be more potent than chloroquine in
    ...
    2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32150618)).
...
1.  **Consideration should be given for use of hydroxychloroquine** in
    ...
    b.  Require supplemental oxygen OR are inpatients not on
        supplemental oxygen but at high risk for progression to severe
        disease
...
1.  **Hydroxychloroquine:** 400mg PO BID on the first day, followed by
    ...
    b.  The half-life of HCQ is over 7 days, so a 5-day treatment course
        should still yield therapeutic HCQ levels past day 10 ([[Yao et
        al, *Clin Infect Dis*,
        2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32150618)).
...
1.  Hydroxychloroquine is contraindicated in epilepsy and porphyria and
    ...
    b.  Cardiomyopathy and retinopathy
        ...
        i.  Case series and reports have found this to be a long-term
            ...
            short duration in COVID-19, it is not an expected risk
            ([[Nord et al, *Semin Arthritis Rheum*,
            2004]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/15079764);
            [[Yusuf et al, *Eye*,
            2017]{.underline}](https://www.ncbi.nlm.nih.gov/pubmed/28282061)).
...
2.  Given this, the following monitoring is required for patients being
    ...
    a.  Obtain baseline ECG, ECG 3.5 hours after first dose, and daily
        ECG thereafter.
    ...
    d.  Do not start if QTc \> 500 msec (or 550 msec with pacing or
        BBB).
...
1.  SARS-CoV-2, the virus that causes COVID-19, enters via the same
    cell-entry receptor as SARS-CoV, namely angiotensin-converting
    enzyme II (ACE2) ([[Paules et al*, JAMA,*]{.underline}
    [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/31971553)).
    SARS-CoV-2 is thought to have a higher affinity for ACE2 than
    SARS-CoV.
...
2.  ACE2 is expressed in the heart, lungs, vasculature, and kidneys.
    ...
    animal models increase the expression of ACE2 ([[Zheng et al, *Nat
    Rev Cardiol*,
    2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32139904)),
    ...
    2020]{.underline}](https://www.ncbi.nlm.nih.gov/pubmed/32129518)).
...
1.  This remains an area of investigation and it is unclear how these
    ...
    b.  For inpatients, we recommend **against** **routine
        ...
        i.  The American College of Cardiology, American Heart
            ...
            patients with COVID-19 ([[Bozkurt et al,]{.underline}
            *[HFSA/ACC/AHA Statement Addresses Concerns Re: Using RAAS
            Antagonists in COVID-19,]{.underline}*
            [2020]{.underline}](http://www.acc.org/latest-in-cardiology/articles/2020/03/17/08/59/hfsa-acc-aha-statement-addresses-concerns-re-using-raas-antagonists-in-covid-19)).
...
1.  Reports from France indicate possible increase in mortality with
    ...
    corroborated ([[Fang et al, *Lancet Respir Med*,]{.underline} [
    ]{.underline}
    [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32171062);
    [[Day M, *BMJ*,
    2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32184201)).
    WHO clarified on 3/20/20 it does not recommend avoiding NSAIDs as
    initially stated 3/18/20 ([[WHO, *COVID-19 Interim guidance*, March
    2020]{.underline}](http://www.who.int/publications-detail/clinical-management-of-severe-acute-respiratory-infection-when-novel-coronavirus-(ncov)-infection-is-suspected)).
...
1.  While this idea has been popular in mainstream media, there is
    ...
    China]{.underline}](https://clinicaltrials.gov/ct2/show/NCT04264533)
    slated to be complete in the fall of 2020.

    a.  The use of Vitamin C as a treatment for sepsis is beyond the
        scope of this document. A 96-hour infusion of vitamin C did not
        demonstrate significant improvement of organ dysfunction,
        vascular injury or alter inflammatory markers in sepsis patients
        with ARDS, although a reduction in 28-day mortality was
        exhibited (Difference -0.17, p=0.03). (*[[Fowler, et al. JAMA,
        2019]{.underline}](https://jamanetwork.com/journals/jama/fullarticle/2752063)).*
...
1.  Restrictive transfusion strategy (Hct \> 21, Hgb \> 7) is
    recommended.

    a.  If hemodynamically stable, transfuse 1 unit at a time and
        reassess needs.
...
2.  Parsimony is encouraged given:
    ...
    b.  Volume overload is of particular concern in COVID patients.
        ...
        i.  Randomized controlled trials of ICU patients have shown that
            a conservative transfusion strategy (Hgb \> 7) is associated
            with less pulmonary edema, fewer cardiac events and no
            evidence of harm compared to a liberal transfusion strategy
            ([[Hébert et al, *N Engl J Med*,]{.underline} [
            ]{.underline}
            [1999]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/9971864);
            [[Holst et al, *N Engl J Med*,
            2014]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/25270275);
            [[Gajic et al, *Crit Care Med*,
            2006]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/16617262)).
...
3.  For warfarin reversal, use 4 factor-PCC given longer effect and
    lower volume.
...
1.  We encourage all staff who are healthy and eligible to donate to
    make an appointment to donate blood or platelets at the Kraft Family
    Blood Donor Center at DFCI and BWH, either by phone (617.632.3206)
    or
    [[online]{.underline}](https://www.dana-farber.org/how-you-can-help/get-involved/donate-blood-and-platelets/).
...
1.  **Definition:** Defined in studies as troponin \> 99^th^ percentile,
    or abnormal ECG or echocardiographic findings ([[Zhou et al,
    *Lancet*,
    2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32171076)).
...
2.  **Incidence**: Incidence of 7-22% in hospitalized patients with
    ...
    2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32031570);
    [[Chen et al, *Lancet*,
    2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32007143); Shi
    et al, JAMA Cardiology, 2020).

### Pathophysiology

1.  The mechanism is unknown, though several have been proposed, based
    on very limited data outside of case series and reports ([[Ruan et
    al, *Intensive Care Med*,
    2020]{.underline}](https://www.ncbi.nlm.nih.gov/pubmed/32125452);
    [[Hu et al, *Eur Heart J*,
    2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32176300);
    [[Zeng et al, *Preprints*,
    2020]{.underline}](http://dx.doi.org/10.20944/preprints202003.0180.v1))
...
1.  Troponin rise and acute cardiac injury may be late manifestations of
    ...
    a.  Troponin increased rapidly from \~14 days from illness onset,
...
1.  **Troponin:**
    ...
    b.  Inpatients: Check hsTrop every other day
        ...
        i.  If hsTrop \> 200 ng/L or ScvO2 \<60%
            ...
            2.  Perform point-of-care US (POCUS) if you are trained to
                do so

            3.  If no new ECG or echocardiographic abnormalities,
                continue to monitor hsTrop and ScvO2
...
2.  **Telemetry:**
    ...
    c.  For hospitals, with resource-limitations, telemetry is most
        ...
        *Circulation,*]{.underline}
        [2017]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/28974521)).

3.  **ECGs:**

    a.  Daily ECGs are reasonable for individuals with severe COVID-19.

        i.  When possible, print ECGs from the in-room monitor to
    ...
    b.  Cardiology consult or a trained provider should perform POCUS
        ...
        v.  Significant ECG changes
            ...
            1.  If abnormalities are identified on POCUS (e.g. new
                reduction in LVEF \< 50%), a formal TTE should be
                obtained and cardiology consulted.

            2.  Where possible order limited TTEs instead of full TTEs
...
5.  **Cardiac Imaging & Stress Testing:**
    ...
    b.  Stress testing is likely not indicated in individuals with
        active COVID unless in discussion with cardiology consultation.
...
1.  There is no current available data on the incidence of ACS in COVID.
    However, we presume that due to the presence of ACE2 receptors on
    the endothelium, and the known increased risk of ACS in influenza
    that there is a possible increased incidence of ACS among COVID-19
    patients.

    a.  The incidence of ACS is about 6 times as high within seven days
        of an influenza diagnosis than during the control interval -
        incidence ratio 6.05 (95% CI, 3.86 to 9.50) ([[Kwong et al,
        *NEJM*,
        2018]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/29365305)).
...
1.  Myocarditis and pericarditis are potential manifestations of
...
2.  **Time course:**
    ...
    a.  Patients rarely present in shock on admission
        ...
        i.  Natural history seems to favor the development of shock
            after multiple days of critical illness.

3.  **Etiology:**

    a.  The range of reasons for shock is wide and more variable than
...
2.  Obtain a **FULL infectious/ septic workup**, which includes all of
    ...
    a.  Labs: CBC with differential. Note that most COVID patients are
        ...
        al, *N Engl J Med*,
        2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32109013)).
        Two sets of blood cultures, LFTs (for cholangitis/acalculous
...
3.  Assess for **cardiogenic shock**
    ...
    c.  Assess pulse pressure: If \< 25% of the SBP, correlates highly
        with a reduction in cardiac index to less than 2.2 with a
        sensitivity of 91% and a specificity of 83% ([[Stevenson and
        Perloff, *JAMA*,
        1989]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/2913385))
    ...
    d.  Perform POCUS if trained to do so and upload to PACS/Centricity
        ...
        i.  For TTE protocols see [["Cardiac Complications of COVID-19"
            chapter]{.underline}](#_6zfga8b63w2s).
    ...
    g.  Calculate estimated Fick Cardiac Output
        ...
        i.  MDcalc online calculators: [[Fick
            CO]{.underline}](http://www.mdcalc.com/cardiac-output-ficks-formula),
            [[BSA]{.underline}](http://www.mdcalc.com/body-mass-index-bmi-body-surface-area-bsa)
...
4.  Assess for **other causes of shock**:
    ...
    a.  Vasoplegia:
        ...
        i.  Run medication list for recent cardiosuppressive
    ...
    d.  Cytokine storm (see [["Cytokine Activation Syndrome"
        section]{.underline}](#cytokine-activation-syndrome) in this
        chapter below)
...
[[This
video]{.underline}](https://www.khanacademy.org/science/health-and-medicine/circulatory-system-diseases/shock/v/differentiating-shock)
...
1.  The reported rates of sepsis and septic shock are not reported
    ...
    a.  Secondary bacterial infections are reported:
        ...
        iii. 12-19% In H1N1 epidemic ([[MacIntyre et al, *BMC Infect
             Dis*,
             2018]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/30526505))
...
1.  **Antibiosis:**
    ...
    a.  Early empiric antibiotics should be initiated within 1 hour (see
        [["Antibiotic Stewardship" section]{.underline}](#antibiotics)
        within [["COVID-19 Therapies and Clinical Trials"
        chapter]{.underline}](#_kx686gedgtzg))

2.  **Pressors and Fluid Management:**

    a.  **Goal MAP \> 65mmHg**

        i.  While there is emerging data that lower MAP thresholds may
            be beneficial, we recommend following this threshold for
            now.
    ...
    b.  **Pressors**
        ...
        ii. Unless new evidence emerges, standard choices for
            distributive shock (*i.e.*, norepinephrine then vasopressin)
            are recommended, with high vigilance for the development of
    ...
    c.  **Conservative fluid management:**
        ...
        i.  **Do not give conventional 30cc/kg resuscitation**
            ...
            1.  COVID-19 clinical reports indicate the majority of
                ...
                ARDS is mediated in part by pulmonary capillary leak,
                and randomized controlled trials of ARDS indicate that a
                conservative fluid strategy is protective in this
                setting ([[Grissom et al,]{.underline} [*Crit Care Med*,
                2015]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/25599463);
                [[Famous et al, *Am J Respir Crit Care
                Med,*]{.underline}
                [2017]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/27513822);
                [[Silversides et al, *Int Care Med,*]{.underline}
                [2017]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/27734109))

            2.  Conservative fluid management is also part of the most
                recent WHO guidelines. [[WHO, *COVID-19 Interim
                guidance*, March
                2020]{.underline}](http://www.who.int/publications-detail/clinical-management-of-severe-acute-respiratory-infection-when-novel-coronavirus-(ncov)-infection-is-suspected)).
        ...
        ii. **Instead, give 250-500cc IVF and assess in 15-30 minutes**
            ...
            2.  Increase in MAP or decrease in pressor requirement
                ...
                a.  Use isotonic crystalloids; Lactated Ringer's
                    solution is preferred where possible. Avoid
                    hypotonic fluids, starches, or colloids

        iii. **Repeat 250-500cc IVF boluses; Use dynamic measures of
             ...
             2.  Straight Leg Raise: raise legs to 45° w/ supine torso
             ...
             3.  Ultrasound evaluation of IVC collapsibility should only
             ...
             4.  For further guidance, Conservative Fluid Management
                 ...
                 ([[Grissom et al,]{.underline} [*Crit Care Med*,
                 2015]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/25599463)).
...
1.  **Etiology:** See [["Acute Cardiac Injury"
    section]{.underline}](#acute-cardiac-injury).
...
2.  **Incidence:**
    ...
    a.  Heart failure or cardiogenic shock ***was observed***
        ...
        ii. In 33% of patients admitted to an ICU in Washington State
            33% (n=7 of 21) ([[Arentz et al, *JAMA*,
            2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32191259)).

            1.  These patients tended to be older with more
...
1.  Significant concern for cardiogenic shock if any of the following
...
2.  Rule out ACS and complete the initial work up as described in
    [["Cardiac Complications" chapter]{.underline}](#_6zfga8b63w2s).

3.  Ongoing monitoring:

    a.  Labs: Trend troponins to peak, SCvO2 (obtained by upper body
        CVC) or MvO2 q8-12h or with clinical change, Lactate q4-6h, LFTs
        daily (for hepatic congestion)
...
4.  All cardiogenic shock cases require **cardiovascular medicine
    ...
    a.  PA catheters may be placed bedside by experienced providers,
...
1.  Close collaboration with the **cardiovascular medicine consultation
    ...
    a.  Goals: MAPs 65-75, CVP 6-14, PCWP 12-18, PAD 20-25, SVR
        800-1000, SCvO2 \> 60%, CI \> 2.2

        i.  Note: Achieving MAP goal is first priority, then optimize
            other parameters
    ...
    b.  How to achieve goals:
        ...
        ii. Initiate diuretic therapy for CVP \> 14, PCWP \>18, PAD \>
            25

        iii. Initiate inotropic support:

             1.  Dobutamine gtt for SCvO2 \< 60%, CI \< 2.2 and
                 MAP \> 65. Start at 2mcg/kg/min. Up-titrate by
                 1-2mcg/kg/min every 30-60 minutes for goal parameters.
                 Alternative strategies should be considered once dose
...
1.  Patients who experience the following should prompt an immediate
...
2.  The criteria for ECMO and other mechanical cardiovascular support
    ...
    a.  BWH ECMO and Cardiovascular Medicine guidelines are in
        development and will be linked once available.

    b.  For the purposes of general education, a ***hypothetical*** set
        of [inclusion criteria]{.underline} for ECMO or MCS could cover:
...
1.  A subgroup of patients with severe COVID-19 may have cytokine
    activation syndrome and secondary HLH ([[Mehta et al*,
    Lancet,*]{.underline}
    [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32192578)).

    a.  Patients who had cytokine activation developed rapid progression
        to ARDS, shock, and multiorgan failure ([[Chen et al*,
        Lancet,*]{.underline}
        [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32007143))

2.  Pathophysiology:

    a.  Neutrophil activation likely contributes to the pathogenesis of
        cytokine storm and ARDS ([[Wu et al*, JAMA Intern
        Med,*]{.underline}
        [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32167524)).
        [[Wu et
        al]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32167524)
        found that COVID-19 confirmed patients with ARDS have higher
    ...
    b.  Similar patterns of cytokine storm and ARDS have been seen with
        SARS, MERS ([[Kim et al*, J Korean Med Sci,*]{.underline}
        [2016]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/27709848))
    ...
    c.  Other studies have suggested that increased proinflammatory
        ...
        SARS, MERS, and COVID-19 ([[Wong et al*, Clin Exp
        Immunol,*]{.underline}
        [2004]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/15030519))
...
1.  Suspect if clinical deterioration with shock and multiorgan failure.
    ...
    a.  CBC with diff, PT/INR, PTT, fibrinogen, d-dimer, ferritin, liver
        ...
        et al, *Intensive Care Med*,
        2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32125452))

        i.  CRP seems to correlate with disease severity and prognosis
            of COVID-19 ([[Ruan et al, *Intensive Care Med*,
            2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32125452);
            [[Young et al*, JAMA,*]{.underline}
            [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32125362))

        ii. An HScore ([[MDcalc online
            calculator]{.underline}](http://www.mdcalc.com/hscore-reactive-hemophagocytic-syndrome))
...
1.  If high suspicion, discuss with ID about the use of IVIG, steroids,
    ...
    [["Anti-IL6 Agents"
    section]{.underline}](#anti-il6-agents-tocilizumab-siltuximab-sarilumab)
    within [["COVID-19 Therapies and Clinical Trials"
    chapter]{.underline}](#_kx686gedgtzg)). While steroids have been
    implicated with worse lung injury and outcomes, they may be
...
1.  Code Responses to COVID-19 patients are high-risk events for
    healthcare worker exposure due to the aerosolization that occurs
    with chest compressions and intubation

    a.  Use PPE:

        i.  CDC guidelines recommend N95 respirator, face shield, gown
            and gloves be used by all code responders during code events
            ([[CDC Guidelines,
            2020]{.underline}](https://www.cdc.gov/coronavirus/mers/infection-prevention-control.html))
            as well as Face Shield, Gown and Gloves).

    b.  Minimize personnel:

        i.  Use an automated compression device where available to
            minimize personnel.

    c.  Prepare code equipment:

        i.  To limit transmission of virus while passing meds/supplies
            into the patient's room from the code cart, consider
            creating Code Bags inside the Code Cart pre-packed with
            necessary code meds (Epinephrine, Bicarbonate, Calcium etc.)
            and IV/lab supplies.
...
1.  **Efforts should be made to minimize the total number of Code
    ...
    a.  Code responders inside the patient's room who should don full
        PPE prior to entering the patient's room:
        ...
        vi. 2 Chest Compressors, resting compressor holds femoral
            pulse (2)
...
2.  **Circulation**
    ...
    a.  Until a definitive airway is obtained, compression-only CPR
        should be performed. Multiple studies have shown that
        compression-only CPR is non-inferior to standard CPR [[(Svensson
        et al, *NEJM*,
        2010).]{.underline}](https://www.nejm.org/doi/full/10.1056/nejmoa0908991)
...
3.  **Airway**
    ...
    a.  **Initial Airway Management, Prior to Intubation:**
        ...
        ii. Avoid BVM ventilation, high-flow nasal cannula, and
            ...
            2020]{.underline}](https://www.thelancet.com/journals/lanres/article/PIIS2213-2600(20)30084-9/fulltext);
            [[Tran et al, *PLoS
            One*, 2012)]{.underline}](https://www.ncbi.nlm.nih.gov/pubmed/22563403?dopt=Abstract).

        iii. If passive oxygen is not available, place a surgical
             face-mask and a blanket over the patient's face prior to
             chest compressions.

        iv. If the patient does not have a shockable rhythm, proceed
            with Rapid Sequence Intubation as early as possible to limit
            aerosolization
    ...
    b.  **Endotracheal Intubation**
        ...
        i.  Endotracheal intubation is the procedure that subjects the
            ...
            [[(Cheung, *Lancet Resp
            Med*, 2020)]{.underline}](https://www.thelancet.com/journals/lanres/article/PIIS2213-2600(20)30084-9/fulltext).
        ...
        iii. If the pause in chest compressions is excessive and
             endotracheal intubation does not seem likely, consider LMA
             or other extraglottic airway device.
        ...
        v.  Continuous capnography device should be used to monitor
            ventilation [[(Cheung, *Lancet Resp
            Med*, 2020)]{.underline}](https://www.thelancet.com/journals/lanres/article/PIIS2213-2600(20)30084-9/fulltext).
...
4.  **Etiologies to Consider**
    ...
    a.  Data from a [retrospective study in
        Wuhan](https://link-springer-com.ezp-prod1.hul.harvard.edu/article/10.1007%2Fs00134-020-05991-x)
        ([[Ruan et al,]{.underline} [*Intensive Care Med*,
        2020]{.underline}](https://link-springer-com.ezp-prod1.hul.harvard.edu/article/10.1007%2Fs00134-020-05991-x))
    ...
    b.  It is important to attempt to identify and treat reversible
        causes (5H's, 5T's) before stopping the code.
...
5.  **Terminating Resuscitative Efforts**
    ...
    b.  No one factor alone, or in combination, is predictive of outcome
        ...
        resuscitation efforts if return of spontaneous circulation
        (ROSC) has not been achieved within 30 minutes.

    c.  In intubated patients, failure to achieve an ETCO2 of greater
        than 10 mm Hg by waveform capnography after 20 minutes of CPR
        should be considered as one component of a multimodal approach
        to decide when to end resuscitative efforts ([[Mancini et al,
        *Circulation*,
        2015]{.underline}](https://www-ncbi-nlm-nih-gov.ezp-prod1.hul.harvard.edu/pubmed/26472991))

6.  **Post-Resuscitation Care**

    a.  Dispose of, or clean, all equipment used during CPR. Any work
        surfaces used for airway/resuscitation equipment will also need
        to be cleaned.
    ...
    c.  If ROSC is achieved, provide usual post-resuscitation care
        consistent with current recommended guidelines including
        targeted temperature management ([[Donnino et al, *Circulation*,
        2015]{.underline}](https://www.ahajournals.org/doi/full/10.1161/cir.0000000000000313)).
...
1.  Unclear incidence, though case reports suggest there may be
    increased venous thromboembolism (VTE) in COVID-19 patients ([[Xie
    et al, *Radiol Cardiothoracic Imaging,*]{.underline}
    [2020]{.underline}](http://doi.org/10.1148/ryct.2020200067))
...
1.  The mechanism for VTE are unknown and likely multifactorial:
    ...
    c.  Possibly direct endothelial damage from viral injury/ACE2
        binding

2.  Colleagues from Wuhan have reported finding microthrombi in
    pulmonary vasculature on autopsy ([[Luo et al, *Preprints*, 2020
    preprint]{.underline}](http://www.preprints.org/manuscript/202002.0407/v2)),
    which could contribute to local V/Q mismatch or hydrostatic changes
    causing edema. However these mechanisms remain entirely
    hypothetical.

    a.  One theory: SARS-CoV Spike protein can be cleaved by FXa and
        ...
        *medRxiv,*]{.underline} [2020
        preprint]{.underline}](http://doi.org/10.1101/2020.02.27.20027557);
        [[Lin et al, Emerging Microbes & Infections,
        2020]{.underline}](https://www.tandfonline.com/doi/pdf/10.1080/22221751.2020.1746199?needAccess=true&)).
...
2.  If the patient is on direct oral anticoagulants (DOACs) or Warfarin
    for Afib or VTE, switch to full dose anticoagulation (LMWH or UFH,
    as indicated based on renal function or clinical scenario).

3.  While therapeutic anticoagulation has been used empirically in some
    severe COVID-19 patients in Wuhan given the microthrombi in
    pulmonary vasculature (see "Pathophysiology" above), our
    interpretation of the data is that the risks outweigh the benefits
    at this time, unless documented DVT or PE.
...
1.  Limited data: 16 of 183 hospitalized patients in Wuhan had DIC
    ([[Tang et al, *J Thromb Haemost,*]{.underline}
...
1.  Median time to onset of DIC was 4 days into hospital admission
    ([[Tang et al, *J Thromb Haemost,*]{.underline}
    [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32073213)).
...
2.  ISTH DIC score ([[MDcalc online
    calculator]{.underline}](http://www.mdcalc.com/isth-criteria-disseminated-intravascular-coagulation-dic)):
...
4.  Start systemic anticoagulation only if:
    ...
    b.  There has been no mortality benefit of therapeutic
        anticoagulation in DIC ([[Levi et al, *Blood,*]{.underline}
        [2018]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/29255070)).
...
2.  Likely that the most common pathophysiology will be acute tubular
    ...
    China,*]{.underline}
    [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32145717))
    and in some cases cytokine storm.

    a.  Areas for future research: Some have hypothesized that there
        ...
        ([[Fan et al*, medRxiv,*]{.underline}
        [2020]{.underline}](http://dx.doi.org/10.1101/2020.02.12.20022418)).
...
1.  Monitor Creatinine at least daily
    ...
    a.  Studies find variable onset of AKI, from 7 days ([[Cheng et al,
        *medRxiv*, 2020
        preprint]{.underline}](http://dx.doi.org/10.1101/2020.02.18.20023242))
        to 15 days after illness onset ([[Zhou et al, *Lancet*,
        2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32171076)).
        Onset of AKI more rapid and severe in patients with underlying
        CKD ([[Cheng et al, *medRxiv*, 2020
        preprint]{.underline}](http://dx.doi.org/10.1101/2020.02.18.20023242))
...
1.  Consult ICU nephrology early at the first sign of renal injury for
    ...
    b.  At this time, *all confirmed COVID-19 patients* are covered by
...
2.  Managing AKI:
    ...
    b.  Give judicious fluids for suspected prerenal insults, but
        discuss with renal if any ambiguity (see [["Shock"
        chapter]{.underline}](#_dpe5gr1hwjp) for conservative fluid
        recommendations)
...
2.  Renal will be coordinating RRT continuation and initiation
    ...
    a.  Indications for dialysis in COVID-19 patients are the same as
        the indications for all patients.

3.  ICU nephrology will determine the need, timing, and modality of
...
1.  Increased serum creatine, BUN, AKI, proteinuria, or hematuria are
    ...
    *medRxiv*, 2020
    ...
    a.  In two other studies, non-survivors had higher BUN and
        creatinine and higher rates of AKI ([[Wang et al, *JAMA*,
        2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32031570)*;*
        [[Yang et al*, Lancet Respir Med,*]{.underline}
        [2020)]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32105632).

    b.  Another study found that higher BUN and creatinine are
        associated with progression to ARDS, and higher BUN (though not
        creatinine) is associated with death (HR 1.06-1.20) ([[Wu et
        al*, JAMA Intern Med,*]{.underline}
        [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32167524)).

    c.  In SARS, AKI correlated with poor prognosis and 91.7% of
        patients with AKI died (vs 8.8% without AKI, p \< 0.0001) ([[Chu
        et al*, Kidney Int*,]{.underline} [ ]{.underline}
...
1.  **Incidence:**
    ...
    a.  The incidence of direct hepatic injury is confounded by
        ...
        i.  The only reported post-mortem liver biopsy from a patient
            with COVID-19 showed only microvesicular steatosis, a common
            finding in sepsis

    b.  Up to 53% of patients have abnormal alanine aminotransferase
        (ALT) and aspartate aminotransferase (AST) \[[[Zhang et al*,
        Lancet Gastroenterol Hepatol,*]{.underline}
        [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32145190)\].
        ...
        i.  Given often elevated CK, this may also represent a myositis
            ...
            2020]{.underline}](https://doi.org/10.1016/S2468-1253(20)30084-4)\].

    c.  Bilirubins and alkaline phosphatase tend to be spared

        i.  54% of patients hospitalized for COVID-19 at a single center
            in China had elevated gamma-glutamyl transferase (GGT).

2.  Clinical course:

    a.  In general, liver injury in mild COVID-19 disease is transient
        and self-resolving. However, liver injury correlates with
        severity

        i.  ALT \> 40 is associated with higher odds of in-hospital
            death ([[Zhou et al, *Lancet*,
            2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32171076)).

        ii. AST is associated with progression to ARDS but not death;
            total bilirubin is associated with both progression to ARDS
            and death ([[Wu et al*, JAMA Intern Med,*]{.underline}
            [2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32167524)).

    b.  Acute liver failure has not been reported \[[[Ong et al, *BMJ*,
        2020]{.underline}](http://dx.doi.org/10.1136/gutjnl-2020-321051)\].
    ...
    a.  Possible mechanisms of liver injury include:
        ...
        i.  Direct liver injury (viral hepatitis)
            ...
            1.  In SARS direct liver injury is seen in up to 60% of
                patients. Liver biopsies from 3 patients with SARS
                showed mild to moderate lobular inflammation, apoptosis,
                and prominent mitotic activity of hepatocytes \[[[Chau
                et al, Hepatology,
                2004]{.underline}](https://doi.org/10.1002/hep.20111)\].

            2.  ACE2 receptors are highly expressed within the biliary
                tree but not in hepatocytes \[[[Chai et al, BioRxiv,
                2020]{.underline}](https://doi.org/10.1101/2020.02.03.931766)\].
        ...
        iv. Cytokine/ immune effects
            ...
            1.  Other respiratory viruses produce similar elevations of
                ...
                and Kupffer cells.\[[[Bangash et al, Lancet
...
2.  **Oncology Consultation/Coverage:**
    ...
    a.  For established DFCI patients, oncology consultation and
...
3.  **Prognosis:**
    ...
    a.  Many patients have reasonable or even good prognosis with
        current therapies. Do not assume a prognosis, involve outpatient
        attending.
...
6.  **Exam**:
    ...
    c.  In patients with Heme Malignancy or SCT: Findings are more
        subtle or absent in neutropenic and immune suppressed patients.
        Examine catheters daily. Avoid rectal exam.
...
9.  **Anticoagulation:**
    ...
    b.  Thrombosis prophylaxis for all unless contraindicated
        ...
        iii. See [["Thrombotic Disease"
             section]{.underline}](#thrombotic-disease) within
             [["Thrombotic and Coagulation Manifestations"
             chapter]{.underline}](#_5s70bzlr4ojz) for guidelines on
             both prophylactic and therapeutic anticoagulation.
...
10. **Transfusions:**
    ...
    b.  See "Blood Transfusions" section for additional details
        ...
        ii. Platelet transfusion if Platelets \< 10K. Higher transfusion
            ...
            1.  Platelet count \> 20K if mild bleeding (*i.e.*,
                epistaxis, line oozing) or if patient has rigors.
...
2.  **Workup:**
    ...
    a.  Blood cultures from peripheral (ideally two sets), and each
...
3.  **Initial Empiric Antibiotics:**
    ...
    a.  GNRs: Ceftazidime OR Cefepime
        ...
        i.  Alternatives: Piperacillin-tazobactam (2nd line) or
            meropenem (3rd line).
...
6.  **Antiinfective course:**
    ...
    a.  Anti-Infectives should be continued until the patient has met
...
2.  **Immune toxicity**
    ...
    b.  Common immune toxicities include pneumonitis / respiratory
        ...
        i.  Check TSH, ACTH, cortisol, T-spot, HIV, HBV, HCV serologies
            if concerned.
...
2.  **Pharmacologic:**
    ...
    b.  Ativan (as above) can be used to ease the anxiety associated
        with dyspnea, but would avoid in patients who have had a
        previous paradoxical reaction (i.e. worsened agitation).

    c.  **Opioids** can be used for both **dyspnea** and **acute pain
        (see below)**
...
1.  **General principles:**
    ...
    a.  Additional information, including algorithm for opioid-induced
        ...
        Book]{.underline}](http://pinkbook.dfci.org/assets/docs/pinkBook.pdf)
...
+----------+---------+----------------------+----------------------+
| **COPD** | **No**  | -   **Morphine**     | -                    |
|          |         |     > 5-10mg PO q3h  |    **Hydromorphone** |
|          |         |     > PRN (use the   |     > 1-2mg PO q3h   |
|          |         |     > 20mg/ml        |     > PRN            |
|          |         |     > concentrate)   |                      |
|          |         |                      | -                    |
|          |         | -   **Morphine**     |    **Hydromorphone** |
|          |         |     > 2-4mg IV q2h   |     > 0.1-0.2mg IV   |
|          |         |     > PRN            |     > q2h PRN        |
+----------+---------+----------------------+----------------------+
|          | **Yes** | -   **Morphine**     | -                    |
|          |         |     > 2-5mg PO q4h   |    **Hydromorphone** |
|          |         |     > PRN (use the   |     > 2-4mg PO q4h   |
|          |         |     > 20 mg/ml       |     > PRN            |
|          |         |     > concentrate)   |                      |
|          |         |                      | ```{=html}           |
|          |         | -   **Morphine** 1-2 | <!-- -->             |
...
a.  [If patient is not well managed with the above, add opioid
    infusion:]{.underline}
    ...
    iii. Continue PRN dosing at current dose (if effective) or titrate
         as per above.
...
3.  **For Opioid tolerant patients:**
    ...
    a.  If able to take PO:
        ...
        ii. Continue current oral PRN dose if effective q4h prn
            ...
            1.  If ineffective, increase dose by 50% and order range of
                up to 3 x basal dose

                a.  e.g. 5 mg PO MS q3h prn; increase to 7.5 mg; 7.5-22
                    mg PO q3h PRN

    b.  If unable to take PO, severe or rapidly escalating symptoms:

        i.  [Convert as-needed PO doses to IV pushes as
            needed]{.underline}

            1.  Use the IV Conversion chart (see chart below, or [[DFCI
                Pink
                Book]{.underline}](http://pinkbook.dfci.org/assets/docs/pinkBook.pdf))

            2.  Decrease PRN dose by ⅓ for incomplete cross-tolerance
                when switching between opioid classes

                a.  e.g. to convert 20 mg of oxycodone to IV
                    hydromorphone: 20 mg oxy = 1.5 mg IV hydromorphone;
                    1.5 mg x ⅔ =1 mg IV
        ...
        ii. [Convert PO long-acting/ sustained release opioids to an
            ...
            1.  Calculate 24-hour dose of PO sustained release (SR)
                ...
                a.  Divide by 3 for the total 24h mg ***IV*** (Morphine
                    PO/IV = 3:1)

            2.  Divide the 24h mg IV total by 24h for the hourly drip
                rate (mg)

                a.  e.g. 30 mg SR PO morphine q8 hr= 90 mg PO in 24 h;
                    90 mg /3 = 30 mg IV dose; 30 mg / 24 h\~ 1 mg/hr IV
                    morphine infusion

            3.  Continue PRN dosing. PRN dose should be 100-200% of
                opioid drip rate

                a.  e.g. 1 mg/hr IV morphine infusion; PRN dose is 1-2
                    mg IV q2h
...
1.  **Diagnosis:**
    ...
    a.  [[Confusion Assessment Method (CAM)
        method]{.underline}](https://docs.google.com/document/d/1xkvBuIRF32g6Rzm_FpC60ZH792ODgfiSfPYmyOlfp9s/edit?ts=5e7e6f11#bookmark=id.em27x4y8ma12)
...
2.  **Treatment:**
    ...
    a.  Non-pharmacologic:
        ...
        ii. Consult Psychiatry; for terminal delirium, consult
            Palliative Care
    ...
    b.  Pharmacologic
        ...
        i.  Additional information available at: [[Guidelines for Acute
            Hospital Acquired
            Delirium]{.underline}](http://www.bwhpikenotes.org/policies/Pharmacy/Drug_Administration/DAG/DeliriumGuide.pdf)
            (Partners login required)

        ii. Alter existing medications and treat comorbid symptoms.

        iii. QTc prolonging agents \<65 yo or DNR/I +LLST Comfort
             Measures

             1.  Haloperidol, Mild agitation:0.5-1.0 mg IV or 1 to 2 mg
                 PO q6h and 1-2 mg q2h PRN.; Moderate agitation: 2-4 mg
                 IV; Severe agitation: 4-10 mg Maximum dose: 20 mg / 24
                 hours

             2.  If refractory, olanzapine, 2.5 to 5 mg (PO, SL, or IV)
                 q12 hr and 2.5 mg q4h PRN; Maximum dose: 30mg / 24
                 hours
        ...
        v.  Non-QTc prolonging agents
            ...
            1.  Aripiprazole (Abilify), 5 mg PO daily; maximum dose
                30 mg daily
...
1.  Match treatment to etiology of nausea:
    ...
    c.  CNS cortical centers:
        ...
        i.  lorazepam for anticipatory nausea, dexamethasone (tumor
            burden causing ICP)
...
2.  Additional information can be found at the [[DFCI Green
    Book]{.underline}](http://pinkbook.dfci.org/assets/docs/greenBook.pdf).
    **See page 11** for more dosing recommendations:

    a.  Ondansetron 8-24mg/day IV/PO (max single dose 16mg) \*causes
        constipation\*

    b.  Haloperidol 0.5-2 mg IV/PO q 4-8 hours \*EPS unlikely at these
        low doses\*
...
2.  If unable to take oral agents, suggest Bisacodyl suppository PR
    daily prn signs of abdominal discomfort/distention likely due to
    constipation.
...
1.  Signs and symptoms of imminent death
    ...
    d.  Gurgling sounds from oropharynx (often more distressing to
        family than patient)
...
2.  Symptom management
    ...
    b.  [[Intensive Comfort Measures Guidelines (BWH Policy
        5.5.5)]{.underline}](https://hospitalpolicies.ellucid.com/documents/view/2663)

3.  Communication

    a.  [[Table 1: Common questions from
        families]{.underline}](https://docs.google.com/document/d/1xkvBuIRF32g6Rzm_FpC60ZH792ODgfiSfPYmyOlfp9s/edit?ts=5e7e6f11#bookmark=id.fsucgfacw0we)

### Terminal Extubation

1.  See [[Von Gunten and Weissman, Palliative Care Fast Fact \#33,
    Ventilator Withdrawal
    Protocol]{.underline}](https://www.mypcnow.org/fast-fact/ventilator-withdrawal-protocol/)

### Palliative Sedation

1.  See [[Salacz and Weissman, Palliative Care Fast Fact \#106,
    Controlled Sedation for Refractory
    Suffering]{.underline}](https://www.mypcnow.org/fast-fact/controlled-sedation-for-refractory-suffering-part-1/)

2.  [[BWH Palliative Sedation in the non-ICU Setting Policy (BWH Policy
    1.4.13)]{.underline}](https://hospitalpolicies.ellucid.com/documents/view/2525.pdf)
...
2.  Communicate with families to expect sounds:
    ...
    a.  Reassure them that although the "rattling" sound is distressing
        to hear, the patient is not experiencing difficulty breathing or
        having to clear phlegm from his or her throat. The rattling
        sound comes from the movement of air over secretions pooled in
        the throat and airways.

3.  Pharmacologic management (not to be used with secretions with
    significant mucous)

    a.  Glycopyrrolate 0.2 -- 0.4mg IV q2hrs prn secretions, rattling
        sound
    ...
    c.  Scopolamine 1.5mg TD q72hrs if patient not awake and no apparent
        delirium or history of delirium. NB The patch will take \~ 12
        hours to take effect

    d.  Avoid using [\>]{.underline} 2 of these at the same time; if
        more than one is required, monitor for development of
...
1.  **Skills for COVID-19 Scenarios**
    ...
    i.  Experts at VitalTalk have created a [[COVID-19 Communication
        Guide]{.underline}](https://www.vitaltalk.org/guides/covid-19-communication-skills/).
        See also: [[Table 2: Suggested Language for COVID-19
        scenarios]{.underline}](https://docs.google.com/document/d/1xkvBuIRF32g6Rzm_FpC60ZH792ODgfiSfPYmyOlfp9s/edit?ts=5e7e6f11#bookmark=id.rjvzl4xkcktj)

2.  **Important Skills for All Conversations**

    a.  **Respond to emotion with empathy**

        i.  [Key Skill]{.underline}: NURSE Statements ([[Back et al. *CA
            Cancer J Clin*]{.underline}
            [2005]{.underline}](https://acsjournals.onlinelibrary.wiley.com/doi/full/10.3322/canjclin.55.3.164?sid=nlm%3Apubmed))

            1.  Name, Understand, Respect, Support, Explore

            2.  [[Nurse Skills for Responding to
                Emotion]{.underline}](https://docs.google.com/document/d/1xkvBuIRF32g6Rzm_FpC60ZH792ODgfiSfPYmyOlfp9s/edit?ts=5e7e6f11#bookmark=id.cmljede59z4n)

    b.  **Assess Understanding & Delivering Information**

        i.  [Key Skill]{.underline}: [[Table 4:
            ASK-TELL-ASK]{.underline}](https://docs.google.com/document/d/1xkvBuIRF32g6Rzm_FpC60ZH792ODgfiSfPYmyOlfp9s/edit?ts=5e7e6f11#bookmark=id.a0yriodvygh0)
            ([[Back et al. *CA Cancer J Clin*]{.underline}
            [2005]{.underline}](https://acsjournals.onlinelibrary.wiley.com/doi/full/10.3322/canjclin.55.3.164?sid=nlm%3Apubmed))

        ii. For COVID, it is important to make patients and families
            aware that patients with significant comorbid illnesses or
            who have poor baseline functional or health status may
            decompensate rapidly and have very high mortality due to
            COVID-19 (see [["Non-ICU Management, Triage, Transfers"
            chapter]{.underline}](https://docs.google.com/document/d/1arxC_2CCuHSA5jyFDPvBlW31yArLinMvjwD3FM5PeI4/edit#heading=h.d36vdx67mxka)).

    c.  **Discussing Goals of Care**

        i.  [Key Skill]{.underline}: REMAP mnemonic ([[Childers et al.
            *J Oncol Pract*]{.underline}
            [2017]{.underline}](https://ascopubs.org/doi/pdfdirect/10.1200/JOP.2016.018796))

            1.  Reframe, Expect Emotion, Map Values, Align, Propose Plan

            2.  [[Table 5: The REMAP
                Framework]{.underline}](https://docs.google.com/document/d/1xkvBuIRF32g6Rzm_FpC60ZH792ODgfiSfPYmyOlfp9s/edit?ts=5e7e6f11#bookmark=id.9l6v3yzefhej)

    d.  **Managing Uncertainty**

        i.  [Key Skill:]{.underline} Pairing hope and worry ([[Jackson
            et al, *JPM*]{.underline}
            [2013]{.underline}](https://www.liebertpub.com/doi/full/10.1089/jpm.2012.0547?casa_token=ewl7uy3IWTIAAAAA%3A-rzmkg24bvC14LANAstAtOU-bpIPDhp-_25ti0SXyfhvLKW2jcvkdBgAUs-aOi42CQLYu8zy8sATRA))

            1.  "I hope you will improve AND I am also worried because
                your oxygen level is getting worse."
...
1.  The **Advance Care Planning (ACP) Module** **in Epic** is the single
    ...
    ACP Module in
    Epic.]{.underline}](https://docs.google.com/document/d/1xkvBuIRF32g6Rzm_FpC60ZH792ODgfiSfPYmyOlfp9s/edit?ts=5e7e6f11#bookmark=id.2og2q7avchju)

2.  In conscious patients, review or sign [[Health Care Proxy
    form]{.underline}](http://www.massmed.org/patient-care/health-topics/health-care-proxies-and-end-of-life-care/massachusetts-health-care-proxy---information,-instructions-and-form-(pdf)/).
...
2.  Below are general considerations and references about resource
    ...
    Pittsburgh]{.underline}](https://ccm.pitt.edu/sites/default/files/UnivPittsburgh_ModelHospitalResourcePolicy.pdf).
...
1.  A "crisis standard of care" is a set of principles to help guide
    ...
    2012]{.underline}](https://www.ncbi.nlm.nih.gov/books/NBK32749/)).
...
3.  It allows transparency. Transparency in decision making,
    particularly when resources are scarce and cannot be allocated to
    all who are in need, is essential ([[Biddison et al.
    2014]{.underline}](https://www.ncbi.nlm.nih.gov/pubmed/25144262))
...
1.  The goal of triage is to maximize population benefit while treating
    ...
    a.  This is different from the usual goal in medicine of promoting
...
3.  Several other strategies have been proposed to allocate scarce
    ...
    ([[NY State Task Force
    2015]{.underline}](https://www.health.ny.gov/regulations/task_force/reports_publications/docs/ventilator_guidelines.pdf)).
    These include:
...
4.  Consensus statement policies ([[Biddison et al.
    2014]{.underline}](https://www.ncbi.nlm.nih.gov/pubmed/25144262))
    suggest no ethical difference between withholding and withdrawing
    care.

### Structure of triage teams

1.  Consensus guidelines suggest that all decisions about triage are
    made by a Triage Officer, not the bedside clinicians caring for
    patients ([[Christian
    2014]{.underline}](https://www.ncbi.nlm.nih.gov/pubmed/25144591)).

2.  The Triage Officer should be a physician with critical care
    training.
...
3.  Decisions about triage should be made based on protocols established
    ...
    2009]{.underline}](https://www.ncbi.nlm.nih.gov/pubmed/19952324))

4.  Bedside clinicians, patients, and families should have mechanisms
    for appealing triage decisions.

5.  An oversight committee should be established to review decisions
    made by Triage Officers to ensure consistent application of the
    triage protocol and to adjudicate appeals.
...
1.  Regardless of scarcity, clinicians have a duty to care for all
    ...
    a.  The duty to care requires that clinicians accept a reasonable
        level of risk in the provision of care, founded in the
        principles of fidelity, respect for persons, and
        non-abandonment.

    b.  There is a corollary obligation of organizations to ensure risk
        is minimized to clinicians as much as possible through, for
        example, the provision of personal protective equipment
        ([[Veterans Health Administration
        2010]{.underline}](https://www.ethics.va.gov/docs/pandemicflu/Meeting_the_Challenge_of_Pan_Flu-Ethical_Guidance_VHA_20100701.pdf)).
...
implementation]{.underline}. If a contraindication is present, discuss
...
[^1]: *Setting the lower oxygen limits:*
    ...
    > cognitively impaired survivors versus mean PaO2 86 \[IQR, 70-98\]
    > in non-impaired survivors of ARDS ([[Mikkelsen et al, *Am J Respir
    > Crit Care Med*,
    > 2012]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/22492988)).
    > In the LOCO~2~ multi-center, randomized clinical trial, patients
    > with ARDS were randomized to their PaO2 55-70, SpO2 88-92%; or
    > PaO2 90-105, SpO2 \>95%); the trial was stopped after enrollment
    > of 205 patients due to futility and safety concerns (44% mortality
    > in conservative oxygen group versus 30%; ([[Barrot et al, *New Eng
    > J Med*,
    > 2020]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/32160661)).

[^2]: *Avoiding hyperoxia:*
    ...
    > Care*,
    > 2013]{.underline}](http://www.ncbi.nlm.nih.gov/pubmed/23271823).

[^3]: Anecdotal reports of efficacy in COVID-19; however data for
